...
class DisciplinaController {
  private static readonly url = "/api/instituicao/disciplinas";

  /**
   * criar
   */
  public async criar(data: DisciplinaData) {
    const body = await fetch(DisciplinaController.url, {
      method: "POST",
   ...
   * actulizar
   */
  public async actualizar(data: DisciplinaData) {
   ...
   * obter
   */
  public async obter(): Promise<DisciplinaData[]> {
    const body = await fetch(DisciplinaController.url).then((res) =>
      res.json()
    );
